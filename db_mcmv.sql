...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 09-Nov-2018 às 16:33
...
CREATE TABLE IF NOT EXISTS `dependentes` (
  ...
  `documentacao` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  `ocupacao` varchar(30) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `principal` (
  ...
  `est_civil` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `escolaridade` varchar(22) COLLATE utf8_unicode_ci DEFAULT NULL,
  `imovel` varchar(15) COLLATE utf8_unicode_ci DEFAULT NULL,
  `comodos` int(2) DEFAULT NULL,
  `aluguel` double DEFAULT NULL,
  `risco` tinyint(1) DEFAULT NULL,
  `deficiencia` varchar(25) COLLATE utf8_unicode_ci DEFAULT NULL,
